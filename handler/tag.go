...
func AddTag(h *Handler) gin.HandlerFunc {
...
func GetAllTags(h *Handler) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func GetTag(h *Handler) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func UpdateTag(h *Handler) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func DeleteTag(h *Handler) gin.HandlerFunc {
	return func(c *gin.Context) {
		tagID := c.Param("tag_id")
